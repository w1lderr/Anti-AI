...
🛡️ **Anti-AI** is a Windows console app built for team work as the final exam project for **Object** at **ITSTEP (IT SCHOOL)**. The tool blocks access to popular AI services by combining Windows Filtering Platform (WFP) rules with hosts file overrides.
